    ...
    <div class="nav2">
      ...
      <div class="myTable">
        <vxe-table :data="tableData">
          ...
          <vxe-table-column field="cardPhoneNum" title="牛人电话数"></vxe-table-column>
          <vxe-table-column field="jobPhoneNum" title="职位电话数"></vxe-table-column>
    ...
    <el-dialog title="编辑" :visible.sync="dialogVisible" width="30%" :before-close="handleClose">
      <div class="xxglForm">
        <el-form :model="xxglForm" ref="xxglForm" label-width="80px" class="demo-ruleForm">
          ...
          <el-form-item label="牛人电话数">
            <el-input size="small" v-model="xxglForm.cardPhoneNum"></el-input>
          </el-form-item>
          <el-form-item label="职位电话数">
            <el-input size="small" v-model="xxglForm.jobPhoneNum"></el-input>
          </el-form-item>
          <el-form-item>
...
export default {
  ...
  methods: {
    ...
    tabEdit(row) {
      ...
      this.xxglForm.cardPhoneNum = row.cardPhoneNum;
      this.xxglForm.jobPhoneNum = row.jobPhoneNum;
      this.dialogVisible = true;
    },
    async submitForm() {
      const res = await this.$api.mvipUpdateVIPType({
        id: this.id,
        price: this.xxglForm.price,
        vipName: this.xxglForm.vipName,
        cardPhoneNum: this.xxglForm.cardPhoneNum,
        jobPhoneNum: this.xxglForm.jobPhoneNum,
      });
      console.log(res);
      if (res.status == 0) {
        this.$message({

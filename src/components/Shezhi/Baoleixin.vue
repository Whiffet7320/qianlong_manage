    ...
    <div class="nav2">
      ...
      <div class="myTable">
        <vxe-table :data="tableData">
          ...
          <vxe-table-column field="specName" title="标题"></vxe-table-column>
      ...
      <div class="xxglForm">
        <el-form :model="xxglForm" ref="xxglForm" label-width="80px" class="demo-ruleForm">
          <el-form-item label="标题">
            <el-input size="small" disabled v-model="xxglForm.specName"></el-input>
          </el-form-item>
...
export default {
  ...
  methods: {
    async getData() {
      const res = await this.$api.jobTopTypeRefresh();
      console.log(res);
    ...
    tabEdit(row) {
      ...
      this.xxglForm.specName = row.specName;
      this.dialogVisible = true;
    },
    async submitForm() {
      const res = await this.$api.jobTopTypeUpRefresh({
        id: this.id,
        price: this.xxglForm.price,
        specName: this.xxglForm.specName
      });
      console.log(res);
      if (res.status == 0) {
        this.$message({

      ...
      <div class="fahuomyForm">
        <el-form :model="xiugaiform" ref="fahuoForm" label-width="100px" class="demo-ruleForm">
          ...
          <el-form-item label="个人介绍">
            <el-input type="textarea" size="small" v-model="xiugaiform.info"></el-input>
          </el-form-item>
          <el-form-item>
